...
///
/// Callers must wait for Postgres bootstrap before invoking — pg_control
/// is required to read system_identifier. Returns base path on the
/// theoretically-unreachable read failure rather than panicking.
